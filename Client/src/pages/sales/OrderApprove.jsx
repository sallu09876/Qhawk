...
const initialData = [
  ...
  { id: 2, date: "27-04-2026", ordNo: "362440", salesOfficer: "Shithin", dealerName: "Masakan Distributors", brand: "ODYSSIA", art: "R7901", color: "TN", size: "8X10", qty: 1, unitName: "SOLTEK", unitStock: 45, depoStock: 120, totalStock: 165, colorCode: "#000" },
  { id: 3, date: "27-04-2026", ordNo: "362440", salesOfficer: "Shithin", dealerName: "Masakan Distributors", brand: "TUFF", art: "T6Z52", color: "MH", size: "7X10", qty: 1, unitName: "TUFF", unitStock: 30, depoStock: 85, totalStock: 115, colorCode: "#000" },
  { id: 4, date: "27-04-2026", ordNo: "362440", salesOfficer: "Shithin", dealerName: "Masakan Distributors", brand: "PODZ", art: "E29", color: "CN", size: "11X1", qty: 1, unitName: "PODZ", unitStock: 60, depoStock: 150, totalStock: 210, colorCode: "#000" },
  { id: 5, date: "27-04-2026", ordNo: "362440", salesOfficer: "Shithin", dealerName: "Masakan Distributors", brand: "PODZ", art: "E29", color: "BI", size: "2X5", qty: 1, unitName: "PODZ", unitStock: 60, depoStock: 150, totalStock: 210, colorCode: "#000" },
];
...
export default function OrderApprove() {
  ...
  const handleAction = (type, row) => {
    if (type === 'view') {
      console.log("Viewing approved row:", row);
      alert(`Approved Order Details:\nNo: ${row.ordNo}\nDealer: ${row.dealerName}`);
    } else if (type === 'edit') {
      setEditingId(editingId === row.id ? null : row.id);
    } else if (type === 'delete') {
      if (confirm("Are you sure you want to delete this approved order?")) {
  ...
  return (
    <div className="p-4 md:p-8 animate-in fade-in duration-500">
      <div className="flex flex-wrap items-center gap-3 mb-6">
        <h1 className="text-2xl md:text-3xl font-black text-gray-900 tracking-tight">Order Approved View</h1>
        <span className="bg-[#22c55e] text-white rounded-full px-3 py-1 text-sm font-semibold shadow-sm shadow-green-200">
          Approved
        </span>
      </div>
      ...
      <ControlsCard 
        ...
        onShow={() => console.log("Filtering approved by date...")}
      />
